...
import { ProductContextProvider } from "../pages/products-services/products/ProductContext";
...
import MessagesNew from "../pages/messages2/Messages";
import StarredMessages from "../pages/messages/StarredMessages";
...
import Orders from "../pages/products-services/Orders";
...
import Connections from "../pages/connected-users/Connections";
import ConnectionRequests from "../pages/connected-users/ConnectionRequests";
...
import PaymentContract from "../pages/payments/PaymentContract";
...
import ShippingOptions from "../pages/settings/ShippingOptions";
...
import ProductCard from "../pages/products-services/products/ProductCard";
import ProductList from "../pages/products-services/products/ProductList";
import ProductDetails from "../pages/products-services/products/ProductDetails";
  ...
  return (
    <Suspense fallback={<div />}>
      <Switch>
        ...
        <Route exact path={`${process.env.PUBLIC_URL}/contacts`} component={Contacts}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/contact-requests`} component={ContactRequests}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/blocked-contacts`} component={BlockedContact}></Route>
        ...
        <Route exact path={`${process.env.PUBLIC_URL}/connections`} component={Connections}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/connection-requests`} component={ConnectionRequests}></Route>

        <Route exact path={`${process.env.PUBLIC_URL}/transactions`} component={Transactions}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/bank-accounts`} component={BankAccounts}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/payment-requests`} component={PaymentRequests}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/payouts`} component={Payouts}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/invoice`} component={Invoice}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/payment-contract`} component={PaymentContract}></Route>
        

        <Route exact path={`${process.env.PUBLIC_URL}/team-members`} component={TeamMembers}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/terms-and-condition`} component={TermsAndCondition}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/shipping-options`} component={ShippingOptions}></Route>

        <Route exact path={`${process.env.PUBLIC_URL}/profile`} component={Profile}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/messages`} component={Messages}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/messagesnew`} component={MessagesNew}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/all-messages`} component={Messages}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/starred-messages`} component={StarredMessages}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/archived-messages`} component={ArchivedMessages}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/sent-messages`} component={SentMessages}></Route>
        ...
        <Route exact path={`${process.env.PUBLIC_URL}/blogposts`} component={BlogPost}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/blog/create`} component={CreateBlog}></Route>
        <Route exact path={`${process.env.PUBLIC_URL}/api-keys`} component={APIKeys}></Route>
