...
import { Icon, UserAvatar, Button, LinkItem, LinkList } from "../../slydo-components/Component";
import { findUpper } from "../../utils/Utils";
import { colourOptions } from "./InboxData";
import { ColorOptions } from "../../slydo-components/partials/color-select-menu/ColorMenu";
import {
  DropdownItem,
  DropdownMenu,
  DropdownToggle,
  ...
  return (
    <div className={`nk-ibx-aside toggle-screen-lg ${aside ? "content-active" : ""}`}>
      <div className="nk-ibx-head">
        <h5 className="mb-0">SlydoMail</h5>
        <a
          href="#toggle"
          onClick={(ev) => {
            ev.preventDefault();
