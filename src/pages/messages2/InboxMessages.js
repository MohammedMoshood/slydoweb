...
import { Button, Icon, TooltipComponent } from "../../slydo-components/Component";
...
const InboxMessages = ({
  ...
  const [tagifyOptions, setTagifyOptions] = useState([{ value: "info@slydo.co" }]);
                        ...
                        <ul className="link-list-opt no-bdr">
                          <li>
                            <DropdownItem tag="a" href="#item" onClick={(ev) => ev.preventDefault()}>
                              <Icon name="reply-fill"></Icon> <span>Reply to Ayodeji Moshood</span>
                            </DropdownItem>
                          </li>
                          <li>
                            <DropdownItem tag="a" href="#item" onClick={(ev) => ev.preventDefault()}>
