...
import { Icon, UserAvatar, TooltipComponent } from "../../slydo-components/Component";
    ...
    if (currentTab !== "Trash") {
      ...
      defaultData.forEach((item) => {
        if (item.message.meta.checked === true) {
          ...
          item.message.meta.starred = false;
                        ...
                        <div className={`nk-ibx-item ${item.message.meta.unread ? "" : "is-unread"}`} key={item.id}>
                          ...
                          <div className="nk-ibx-item-elem nk-ibx-item-star">
                            <div className="asterisk">
                              <a
                                href="#item"
                                className={item.message.meta.starred ? "active" : ""}
                                onClick={(ev) => {
                                  ev.preventDefault();
                                  onFavoriteClick(item.id);
                                }}
                              >
                                <Icon name={`${item.message.meta.starred ? "star-fill" : "star"}`}></Icon>
                              </a>
                            </div>
                          </div>
