...
import { countryOptions, profileData } from "../../slydo-components/profile/ProfileData";
import { getDateStructured } from "../../utils/Utils";

const UserProfile = ({ sm, updateSm, setProfileName }) => {
        ...
        <div className="nk-data data-list">
          ...
          <div className="data-item" onClick={() => setModal(true)}>
            <div className="data-col">
              ...
              <span className="data-value">{profileInfo.displayName}</span>
            </div>
            <div className="data-col data-col-end">
              <span className="data-more">
                <Icon name="forward-ios"></Icon>
          ...
          <div className="data-item">
            <div className="data-col">
              ...
              <span className="data-value">info@slydo.co</span>
            </div>
            <div className="data-col data-col-end">
          ...
          <div className="data-item" onClick={() => setModal(true)}>
            <div className="data-col">
              ...
              <span className="data-value text-soft">{profileInfo.phone}</span>
            </div>
            <div className="data-col data-col-end">
              <span className="data-more">
                <Icon name="forward-ios"></Icon>
