...
export const contactsTable = [
  ...
  },
  {
    ...
    cell: (row) => (
      <>
      {/* {row.action} */}
      <RemoveContactModal user={row} />
      &nbsp;
      <BlockContactModal user={row} />
      </>
    ),
  },
];
...
export const contactRequestTable = [
  {
    ...
    cell: (row) => (
      <div className="user-card mt-2 mb-2">
        <UserAvatar theme={row.avatarBg} text={findUpper(row.from_user?.name)} image={row.from_user?.image}></UserAvatar>
        <div className="user-info">
          <span className="tb-lead">
            {row.from_user?.name}{" "}
            {/* <span
  ...
  },
  {
    ...
    cell: (row) => (
      // <span className="tb-amount">
      //   <span className="currency"> {row.to_user?.username} </span>
      // </span>
      <div className="user-card mt-2 mb-2">
        <UserAvatar theme={row.avatarBg} text={findUpper(row.to_user?.name)} image={row.to_user?.image}></UserAvatar>
        <div className="user-info">
          <span className="tb-lead">
            {row.to_user?.name}{" "}
          </span>
  ...
  },
  {
    ...
    cell: (row) => (
      <>
      <AcceptConnectionRequestModal user={row?.to_user?.username} />
        &nbsp;
      <RejectConnectionRequestModal user={row?.to_user?.username}/>
      </>
    ),
  },
];
