              ...
              <Col md="6" lg="5">
                <ProjectCard>
                  <div className="project-head">
                    ...
                    >
                      <UserAvatar className="sq" theme="primary" text={findUpper("slydo Dev")} />
                      <div className="project-info">
                        <h6 className="title">slydo Development</h6>
                  ...
                  <div className="project-details">
                    Design and develop the slydo template for Envato Marketplace.
                  </div>
