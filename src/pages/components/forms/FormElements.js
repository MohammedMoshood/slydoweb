            ...
            <Row className="gy-4">
              ...
              <Col sm="6">
                <FormGroup>
                  ...
                  <input className="form-control" defaultValue="Ayodeji Moshood" placeholder="Input placeholder" />
                </FormGroup>
              </Col>
              <Col sm="6">
                <FormGroup>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                To use the slydo customized version of react-select component import it such as,{" "}
