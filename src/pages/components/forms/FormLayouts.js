            ...
            <form className="gy-3">
                  ...
                  <FormGroup>
                    <div className="form-control-wrap">
                      <input
                        ...
                        defaultValue="slydo Admin Template"
                      />
                    </div>
                  </FormGroup>
                </Col>
              ...
              <Row className="g-3 align-center">
                ...
                <Col lg="7">
                  <FormGroup>
                    <div className="form-control-wrap">
                      <input type="text" id="site-email" className="form-control" defaultValue="info@slydo.co" />
                    </div>
                  </FormGroup>
                </Col>
              </Row>
                  ...
                  <FormGroup>
                    <div className="form-control-wrap">
                      <input
                        ...
                        id="site-copyright"
                        className="form-control"
                        defaultValue="&copy; 2019, slydo. All Rights Reserved."
                      />
                    </div>
                  </FormGroup>
                </Col>
