export const columnData = {
  task: {
    "task-1": {
      ...
      desc: "Start implementing new design in coding @slydo",
      meta: {
        users: [{ value: "Sara Dervashi", label: "Sara Dervashi", theme: "light" }],
        tags: [
          { value: "slydo", label: "slydo", theme: "info" },
    ...
    "task-2": {
      id: "task-2",
      title: "slydo React Version",
      desc: "Implement new UI design in react version @slydo template as soon as possible.",
      meta: {
    ...
    "task-3": {
      id: "task-3",
      title: "slydo Design Kit Update",
      desc: "Update the new UI design for @slydo template with based on feedback.",
      board: "In Progress",
      meta: {
