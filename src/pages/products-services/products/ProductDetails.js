...
import { getProductDetails } from "../../../redux/actions/slydocommerce";
...
const ProductDetails = ({ match }) => {
  ...
  const getProductDetails = async () => {
    ...
    console.log(id, "the id of product")
    ...
    try {
      ...
      console.log(data, "the datat details")
    } catch (error) {
      console.log(error, "the details error")
    }
  }
