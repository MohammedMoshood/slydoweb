...
import { NSComponent } from "../Component";
...
const CheckoutTable = () => {
  ...
  useEffect(() => {
    let filteredData;
    if (trans === "Due") {
      filteredData = checkoutData.filter((item) => item.status === "Due");
    } else if (trans === "Paid") {
      filteredData = checkoutData.filter((item) => item.status === "Paid");
    } else {
    ...
    <React.Fragment>
      <div className="card-inner">
        <div className="card-title-group">
          <CardTitle>
            <h6 className="title">
              <span className="mr-2">Checkout Products</span>{" "}
              {/* <a
                href="#history"
                onClick={(ev) => {
                  ev.preventDefault();
            ...
            <DataTableItem key={idx}>
              ...
              <DataTableRow size="sm">
                ...
                <div className="form-group">
                  ...
                  <NSComponent style={{width: '20%'}} defaultVal={2} color="light" outline max={10} min={1} />
                </div>
              </DataTableRow>
